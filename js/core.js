...
let objToRender = 'little_planet_earth';
...
camera.position.z = objToRender === "little_planet_earth" ? 25 : 500;
...
const ambientLight = new THREE.AmbientLight(0x333333, objToRender === "little_planet_earth" ? 5 : 1);
scene.add(ambientLight);

//This adds controls to the camera, so we can rotate / zoom it with the mouse
if (objToRender === "little_planet_earth") {
